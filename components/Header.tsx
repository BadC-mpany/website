        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            <a
              ...
              className="hidden sm:flex items-center gap-1.5 font-mono text-[10px] md:text-xs text-zinc-400 hover:text-white border border-zinc-800 hover:border-zinc-500 px-2 md:px-3 py-1 md:py-1.5 transition-all duration-200 group"
            >
