...
export default function OpenSource() {
    ...
    const copyCloneCommand = () => {
        navigator.clipboard.writeText('git clone https://github.com/BadC-mpany/sentinel-v1.0')
        setCopied(true)
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white font-mono">
                            SENTINEL <span className="text-zinc-500">FRAMEWORK</span>
                        </h2>

                        <p className="text-xl text-gray-400 mb-8 max-w-xl font-mono leading-relaxed">
                            Our first open source security framework. Establish a deterministic safety envelope for your agents in under 10 minutes.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            ...
                            <a
                                href="https://github.com/BadC-mpany/sentinel"
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        <div className="bg-[#0d1117] border border-zinc-800 rounded-xl p-6 shadow-2xl relative overflow-hidden group hover:border-zinc-700 transition-all">
                            ...
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-white font-bold font-mono text-sm">Sentinel Framework</h3>
