...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center px-6 pt-20 bg-cyber-black">
          ...
          >
            ...
            <div className="max-w-xl">
              ...
              <div className="relative group bg-zinc-900 border border-zinc-800 rounded-lg p-5 flex items-center justify-between hover:border-zinc-700 transition-colors">
                <div className="flex items-center gap-3 font-mono text-sm text-gray-300 overflow-x-auto no-scrollbar">
