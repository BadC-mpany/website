    ...
    <section id="subscribe" className="flex items-center justify-center px-6 py-24 bg-cyber-black border-y border-white/5">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          <p className="text-xl text-zinc-500 mb-12 font-mono max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSubscribe} className="max-w-md mx-auto relative">
            <div className="relative group">
              <input
                ...
                required
                disabled={loading}
                className="w-full px-6 py-4 bg-zinc-900 border border-zinc-800 text-white font-mono placeholder-zinc-600 focus:border-cyber-red/50 focus:outline-none transition-colors duration-200 pr-16"
              />
              <button
                type="submit"
                disabled={loading}
                className="absolute right-2 top-2 bottom-2 px-4 bg-white hover:bg-gray-200 text-black font-mono font-bold transition-colors duration-200 disabled:opacity-50 flex items-center justify-center"
              >
                {loading ? (
            ...
            {message && (
              <motion.div
                ...
                className={`mt-4 text-left font-mono text-sm p-3 border ${message.type === 'success'
