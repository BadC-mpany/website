...
export default function HowItWorks() {
  return (
    <section className="py-20 px-6 bg-cyber-black border-t border-zinc-900">
      <div className="container mx-auto max-w-3xl">
        ...
        >
          ...
          <p className="text-gray-400 font-mono text-base md:text-lg leading-relaxed mt-4 max-w-2xl">
